    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6 gap-2">
                <button type="button" data-theme-toggle class="theme-toggle-btn" data-theme-toggle-label>Theme</button>
            ...
            <div class="-me-2 flex items-center sm:hidden gap-2">
                <button type="button" data-theme-toggle class="theme-toggle-btn text-xs" data-theme-toggle-label>Theme</button>
